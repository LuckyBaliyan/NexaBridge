  ...
  return (
    <div className='relative w-full h-screen hero'>
        <div className="date-wrapper flex justify-between py-25">
          <div className="heading-wrapper pr-0 items-center md:p-4 md:items-start flex flex-col gap-12 md:gap-6">
            <h1 className='leading-[0.9] text-start tracking-tighter'>Welcome To <br /> Nexa Bridge</h1>
            <p className='text-sm px-2  text-center md:text-start md:text-base w-[100%] md:w-[50%] md:pl-2 leading-[1]'>Connect with your alumni network like never before. 
