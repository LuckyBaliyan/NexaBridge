  ...
  return (
    <div className='relative w-full h-screen hero'>
        <div className="date-wrapper flex justify-between py-25">
          <div className="heading-wrapper p-0 items-center md:p-4 md:items-start flex flex-col gap-12 md:gap-6">
            <h1 className='leading-[0.9] text-center md:text-start tracking-tighter'>Welcome To <br /> Nexa Bridge</h1>
            <p className='text-sm px-2 md:px-0 text-center md:text-start md:text-base w-[100%] md:w-[50%] pl-2 leading-[1]'>Connect with your alumni network like never before. 
            ...
            <div className="img-wrapper w-[36vh] h-[24vh] self-center  md:hidden block">
          ...
          <div className="img-wrapper hidden md:relative md:block pr-20">
            <img src="/images/hero.png" alt=""/>
          </div>
        </div>
    </div>
